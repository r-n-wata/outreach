...
export const waterSportRetreats: waterSportRetreatsTypes[] = [
    ...
    includes: [
      {
        ...
        list: [
          ...
          "1 mangrove snorkeling excursion",
          "1 Sailing Excursion the best of the 7 colors lagoon",
          "1 Kayak excursion to the Pirate Channel ",
          "1 Aquatic guided meditation",
          "Pre- and post-retirement support from Outretrets, find the best flight",
          "Professional event photos.",
        ],
      },
    ],
    prices: [
      { title: "Private room for 1 person", price: 1100 },
      { title: "Deluxe room for 1 person", price: 1300 },
    ...
    includes: [
      {
        ...
        list: [
          ...
          "Mexican vegetarian or vegan breakfast and lunch",
          "Daily yoga classes overlooking the lagoon",
          "1 mangrove snorkeling excursion",
          "1 Sailing Excursion the best of the 7 colors lagoon",
          "1 Kayak excursion to the Pirate Channel",
          "1 Stand up paddle board sunrise excursion",
          "1 Aquatic guided meditation",
          "1 Water Holistic Experience in Janzu Water ",
          "1 bike tour ",
  ...
  },
  {
    ...
    summary:
      "For those who want to reintegrate into everyday life in an adequate balance. Whether you are looking to recover from technology addiction, substance abuse, emotional exhaustion, or simply need a deep reset",
    includes: [
      {
        title: "Excursions",
        list: [
